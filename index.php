...
<!--  H1 can have 2 designs: "logo" and "logo cursive"           -->
        ...
        <div class="content">
            <h4 class="motto">Delivering joy right to your doorstep.</h4>
            <div class="subscribe">
                <h5 class="info-text">
                ...
                <div class="row">
                    <div class="col-md-4 col-md-offset-4 col-sm6-6 col-sm-offset-3 ">
                        <form class="form-inline" role="form" action="email.php" method="post">
                        ...
                        <?php echo !empty($_GET['s']) ? "<div class='info-text'>Thanks! We'll keep you postecdd.</div>" : '' ?>
